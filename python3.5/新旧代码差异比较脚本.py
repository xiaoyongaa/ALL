...
class chayi():
        ...
        try:
            ...
            for i in file_list:
                with open(i,"rb") as old:
                    result=self.md5(old.read())  #给每个文件MD5加密
    ...
    def new_code(self):  #求新代码的MD5,放在b集合里面
        try:
            file_list=[]
            file_md5=[]
    ...
    def  duibi(self):
        ...
        if res:
            res=self.new_code()
            if res:
                  a=self.old_code_set  #老的code的集合
                  b=self.new_code_set  #最新的code的集合

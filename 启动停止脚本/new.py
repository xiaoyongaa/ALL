...
if user=="root":
    if os.path.exists(path+"longshine/tmp") and  os.path.exists(path+"longshine/work") and os.path.exists(path+"longshine/data"):
        ...
        os.system("su - jbossadm -c \"mkdir -p /app/jboss-5.1.0.GA/server/longshine/tmp\"")
        os.system("su - jbossadm -c \"mkdir -p /app/jboss-5.1.0.GA/server/longshine/work\"")
        os.system("su - jbossadm -c \"mkdir -p /app/jboss-5.1.0.GA/server/longshine/data\"")
elif user=="jbossadm":
    if os.path.exists(path+"longshine/tmp") and  os.path.exists(path+"longshine/work") and os.path.exists(path+"longshine/data"):
        print("cunzai")
    else:
        exit("bu cunzai")
        os.system("mkdir -p /app/jboss-5.1.0.GA/server/longshine/tmp")
        os.system("mkdir -p /app/jboss-5.1.0.GA/server/longshine/work")
        os.system("mkdir -p /app/jboss-5.1.0.GA/server/longshine/data")
else:
